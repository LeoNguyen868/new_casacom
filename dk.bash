#!/bin/bash
export "DATA_RAW_PATH1=/home/hieu/Work/new_casacom/data/raw"
export "DATA_RAW_PATH2=/home/hieu/Work/new_casacom/data/raw_rt"
export "OUTPUT_DIR=/home/hieu/Work/new_casacom/data/processed"
...
for DATE in "${DATES1[@]}"; do
    ...
    python3 count.py --date "$DATE" --base_path "raw"
...
for DATE in "${DATES2[@]}"; do
    ...
    echo "Starting data processing for $DATE..."
    python3 count.py --date "$DATE" --base_path "raw_rt"
